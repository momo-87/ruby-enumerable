...
```bash
  git clone https://github.com/momo-87/ruby-enumerable.git
```
...
Feel free to check the [issues page](https://github.com/momo-87/ruby-enumerable/issues).
